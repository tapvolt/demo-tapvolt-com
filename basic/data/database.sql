...
VALUES
  (1, 1436709050, NULL, 0, 1436709050, NULL, 1, 'Tapvolt', 'admin@tapvolt.com', '$2y$13$4KlFZSyaDGGxchm.D6xel.yGU95jl1Kc6FDY1r/MK/vkOukfUtMNO', '5Z2EED0SN6-XKtbIpoXNlE29N0WGfrOz', NULL, '192.168.56.1', NULL, NULL, 0);
...
CREATE TABLE `client` (
  ...
  UNIQUE KEY `client_unique_name` (`name`),
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
